...
TOKEN = 'Nzg4OTY4MDIxMzU1NTI4MjEy.X9rNug.4Z9giXi4toUkR900ftP5Tvt0WUY'
...
async def школяр(ctx):
    ...
    embd.set_thumbnail(url="https://school.permkrai.ru/student_diary/assets/dnevnik-logo-cmyk.png")
